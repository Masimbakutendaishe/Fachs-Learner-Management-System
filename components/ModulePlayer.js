      ...
      <main className="flex-1 p-8 overflow-y-auto h-full bg-gray-50">
        ...
        {currentActivity === "guide" && (
          <LearnerGuide
            ...
            chapters={unitWeek.chapters || [
              { title: "Chapter 1: Intro", content: "No content yet." },
            ]}
        ...
        {currentActivity === "teams" && (
          <>
            <TeamsSession
              ...
              endDate={unitWeek.week_end_date}
            />
        ...
        {currentActivity === "practical" && (
          <PracticalEvidenceUpload
            ...
            questions={[
              "Upload evidence for Question 1",
              "Upload evidence for Question 2",
            ]}
            onComplete={(uploads) => {
