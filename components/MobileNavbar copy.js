      ...
      <div className="hidden md:flex items-center space-x-4 font-bold text-xl">
        ...
        {user ? (
          <div className="relative group">
            ...
            {/* Dropdown with email + logout */}
            <div className="absolute right-0 mt-2 w-56 bg-white text-black rounded-lg shadow-lg opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-opacity duration-200">
